...
public class PojoDemo {
    ...
    public static void main(String[] args) {
        ...
        Person person_2 = new Person("Wezley", "Singleton", "wezley.com");
        System.out.println(person_2);

        Person person_3 = new Person("Wezley", "Singleton", "wezley.com", 25);
        System.out.println(person_3);

        Person person_4 = new Person("Wezley", "Singleton", "wezley.com", 25);
