...
public class OverloadingDemo {
    ...
    private static class Overloader {
        ...
        // this results in a compiliation error because we already have a method named
        // test that takes in an array of ints (in the form of varargs)
        // we can fix it by adding or changing parameters in the method signature
        public void test(int num, int[] ints) {
            for (int i : ints) {
                System.out.println(i);
            }
        }
    ...
    public static void main(String[] args) {
        ...
        overloader.test(4, new int[] {1, 2, 3, 4, 5}); // test(int, int[])
